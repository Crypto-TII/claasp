...
def test_build_impossible_xor_differential_trail_model():
    ...
    fixed_variables = [set_fixed_variables(INPUT_KEY, "equal", range(80), (0,) * 80)]
    mzn.build_hybrid_impossible_xor_differential_trail_model(
...
def test_find_all_impossible_xor_differential_trails():
    ...
    key = set_fixed_variables(INPUT_KEY, constraint_type="equal", bit_positions=range(78), bit_values=[0] * 78)
    trails = mzn.find_all_impossible_xor_differential_trails(
        4, [plaintext, ciphertext, key], CHUFFED, 1, 3, 4, False, solve_external=True
    )
    assert len(trails) == 6
    assert trails[0]["status"] == SATISFIABLE
    assert (
        trails[0]["components_values"][INPUT_PLAINTEXT]["value"]
        == "................................................................"
    )
    assert (
        trails[0]["components_values"]["inverse_cipher_output_3_19"]["value"]
        == "................................................................"
    )
...
def test_find_all_improbable_xor_differential_trails():
    ...
    key = set_fixed_variables(
        component_id=INPUT_KEY, constraint_type="equal", bit_positions=range(80), bit_values=[0] * 10 + [1] + [0] * 69
    )
    trails = mzn.find_all_impossible_xor_differential_trails(
        4, [plaintext, ciphertext, key], CHUFFED, 1, 3, 4, False, probabilistic=True, solve_external=True
    )
    assert trails["total_weight"] == 0.0
    assert len(trails["solutions"]) == 6
    assert trails["solutions"][0]["status"] == SATISFIABLE
    assert (
        trails["solutions"][0]["components_values"][INPUT_PLAINTEXT]["value"]
        == "................................................................"
    )
    assert (
        trails["solutions"][0]["components_values"]["inverse_cipher_output_3_19"]["value"]
        == "................................................................"
    )
...
def test_find_one_impossible_xor_differential_trail():
    ...
    assert (
        trail["components_values"][INPUT_PLAINTEXT]["value"]
        == "................................................................"
    )
    assert (
        trail["components_values"]["inverse_cipher_output_3_19"]["value"]
        == "................................................................"
    )
