...
from claasp.cipher_modules.models.minizinc.minizinc_models.minizinc_xor_differential_model import (
    MinizincXorDifferentialModel, and_xor_differential_probability_ddt)
...
def test_find_all_xor_differential_trails_with_fixed_weight():
    ...
    trails = minizinc.find_all_xor_differential_trails_with_fixed_weight(1, solver_name='Chuffed')
...
def test_solving_unsatisfiability():
    ...
    minizinc = MinizincXorDifferentialModel(speck)
    trails = minizinc.find_one_xor_differential_trail_with_fixed_weight(1, solver_name='Chuffed')
...
def test_find_all_xor_differential_trails_with_weight_at_most():
    speck = SpeckBlockCipher(block_bit_size=8, key_bit_size=16, number_of_rounds=2)
    minizinc = MinizincXorDifferentialModel(speck)
    trails = minizinc.find_all_xor_differential_trails_with_weight_at_most(0, 1, solver_name='Chuffed')
...
def test_find_lowest_weight_xor_differential_trail():
    ...
    minizinc = MinizincXorDifferentialModel(speck)
    trail = minizinc.find_lowest_weight_xor_differential_trail(solver_name='Chuffed')
...
def test_find_one_xor_differential_trail():
    ...
    trail = minizinc.find_one_xor_differential_trail([plaintext], 'Chuffed')
...
def test_find_one_xor_differential_trail_with_fixed_weight():
    ...
    plaintext = set_fixed_variables(component_id='plaintext', constraint_type='not_equal',
                                    bit_positions=range(32), bit_values=[0] * 32)
    trail = minizinc.find_one_xor_differential_trail_with_fixed_weight(9, [plaintext], 'Chuffed')
