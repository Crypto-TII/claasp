...
from claasp.cipher_modules.models.sat.solvers import CRYPTOMINISAT
...
def test_find_missing_bits():
    ...
    missing_bits = cms.find_missing_bits(fixed_values=[plaintext, key], solver_name=CRYPTOMINISAT)
