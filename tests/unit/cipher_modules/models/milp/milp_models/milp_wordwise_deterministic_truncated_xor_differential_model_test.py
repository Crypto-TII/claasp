...
def test_find_one_wordwise_deterministic_truncated_xor_differential_trail_model():
    ...
    key = set_fixed_variables(component_id='key', constraint_type='equal', bit_positions=range(128),
                              bit_values=[0] * 128)
    trail = milp.find_one_wordwise_deterministic_truncated_xor_differential_trail(fixed_bits=[key],
...
def test_find_lowest_varied_patterns_wordwise_deterministic_truncated_xor_differential_trail_model():
    ...
    ciphertext = set_fixed_variables(component_id='cipher_output_1_18', constraint_type='equal', bit_positions=range(16),
