...
def test_constructor_builds_permutation_component():
    ...
    assert permutation_component.description == [1, 3, 2, 0]
...
def test_sat_constraints():
    ...
    assert constraints == [
        "permutation_0_0_0 -input_1",
        "input_1 -permutation_0_0_0",
        "permutation_0_0_1 -input_3",
        "input_3 -permutation_0_0_1",
        "permutation_0_0_2 -input_2",
        "input_2 -permutation_0_0_2",
        "permutation_0_0_3 -input_0",
        "input_0 -permutation_0_0_3",
    ]
