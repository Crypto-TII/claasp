...
def test_fsr_algebraic_polynomials():
    ...
    fsr_component = binary_cipher.component_from_id("fsr_0_0")
    ...
    fsr_component = clocked_cipher.component_from_id("fsr_0_0")
    ...
    fsr_component = word_cipher.component_from_id("fsr_0_0")
