...
def test_lea_block_cipher():
    ...
    assert lea.evaluate_vectorized_gpu([plaintext, key], evaluate_api=True) == 0x6fb95e325aad1b878cdcf5357674c6f2
    ...
    assert lea.evaluate_vectorized_gpu([plaintext, key], evaluate_api=True) == 0xd651aff647b189c13a8900ca27f9e197
