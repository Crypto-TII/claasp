...
def test_qarmav2_mixcolumn_block_cipher():
    ...
    assert qarmav2.id == 'qarmav2_block_cipher_k128_p64_t128_o64_r9'
    ...
    #assert qarmav2.evaluate_vectorized_gpu([key, plaintext, tweak], evaluate_api = True) == ciphertext
