...
def test_toyaes_block_cipher():
    aes = ToyAESBlockCipher()
    assert aes.type == 'block_cipher'
    assert aes.family_name == 'toyaes_block_cipher'
    assert aes.number_of_rounds == 10
    assert aes.id == 'toyaes_block_cipher_k128_p128_o128_r10'
...
def test_toyaes128_block_cipher():
    aes = ToyAESBlockCipher()
    key = 0x2b7e151628aed2a6abf7158809cf4f3c
    plaintext = 0x6bc1bee22e409f96e93d7e117393172a
    ciphertext = 0x3ad77bb40d7a3660a89ecaf32466ef97
...
def test_toyaes_8_3_block_cipher():
...
def test_toyaes_8_2_block_cipher():
...
# def test_toyaes_4_4_block_cipher():
...
#     assert aes.evaluate_vectorized([key, plaintext], evaluate_api=True) == ciphertext
#
# def test_toyaes_4_3_block_cipher():
...
#     assert aes.evaluate_vectorized([key, plaintext], evaluate_api=True) == ciphertext
#
# def test_toyaes_4_2_block_cipher():
...
def test_toyaes_3_4_block_cipher():
...
def test_toyaes_3_3_block_cipher():
...
def test_toyaes_3_2_block_cipher():
...
def test_toyaes_2_4_block_cipher():
...
def test_toyaes_2_3_block_cipher():
...
def test_toyaes_2_2_block_cipher():
