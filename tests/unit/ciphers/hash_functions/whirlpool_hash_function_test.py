...
def test_whirlpool_hash_function():
    ...
    assert whirlpool.id == 'whirlpool_hash_function_m512_o512_r10'
    ...
    assert whirlpool.id == 'whirlpool_hash_function_m512_o512_r4'
    ...
    assert whirlpool.evaluate_vectorized_gpu([message], evaluate_api=True) == digest
