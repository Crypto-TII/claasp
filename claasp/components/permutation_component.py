...
class Permutation(LinearLayer):
    ...
    This is the legacy permutation component that models permutations as binary matrices
    (inheriting from LinearLayer). For a lightweight bit-equality based permutation,
    use PermutationBitwise instead.
