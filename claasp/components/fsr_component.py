...
class Fsr(Component):
    ...
    def algebraic_polynomials(self, model):
        ...
        EXAMPLES::
            ...
            sage: fsr_component = binary_cipher.component_from_id("fsr_0_0")
            ...
            sage: fsr_component = clocked_cipher.component_from_id("fsr_0_0")
            ...
            sage: fsr_component = word_cipher.component_from_id("fsr_0_0")
