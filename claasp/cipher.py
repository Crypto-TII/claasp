...
class Cipher:
    ...
    def find_good_input_difference_for_neural_distinguisher(self, difference_positions,
        ...
        return NeuralNetworkDistinguisher(self).find_good_input_difference_for_neural_distinguisher(
    ...
    def train_neural_distinguisher(self, data_generator, starting_round, neural_network, training_samples=10 ** 7,
        ...
        if pipeline:
            ...
            acc = NeuralNetworkDistinguisher(self).neural_staged_training(data_generator, starting_round, neural_network, training_samples,
                                         testing_samples, epochs)
        else:
            # from claasp.cipher_modules.neural_network_tests import train_neural_distinguisher
            acc = NeuralNetworkDistinguisher(self).train_neural_distinguisher(data_generator, starting_round, neural_network, training_samples,
                                             testing_samples, epochs)
        return acc
    ...
    def train_gohr_neural_distinguisher(self, input_difference, number_of_rounds, depth=1, word_size=0,
        ...
        def data_generator(nr, samples):
            return NeuralNetworkDistinguisher(self).get_differential_dataset(input_difference, number_of_rounds=nr,
                                            samples=samples)
        ...
        neural_network = NeuralNetworkDistinguisher(self).get_neural_network('gohr_resnet', input_size = input_size, depth=depth, word_size=word_size)
        return NeuralNetworkDistinguisher(self).train_neural_distinguisher(data_generator, number_of_rounds, neural_network, training_samples,
    ...
    def run_autond_pipeline(self, difference_positions=None, optimizer_samples=10 ** 4, optimizer_generations=50,
        ...
        diff, scores, highest_round = self.find_good_input_difference_for_neural_distinguisher(difference_positions,
                                                                                               ...
                                                                                               verbose=verbose)
        input_difference = NeuralNetworkDistinguisher(self).int_difference_to_input_differences(diff[-1], difference_positions, self.inputs_bit_size)
        input_size = self.output_bit_size * 2
    ...
    def neural_network_blackbox_distinguisher_tests(
        ...
        return NeuralNetworkDistinguisher(self).neural_network_blackbox_distinguisher_tests(
            nb_samples, hidden_layers, number_of_epochs)
    ...
    def neural_network_differential_distinguisher_tests(
        ...
        return NeuralNetworkDistinguisher(self).neural_network_differential_distinguisher_tests(
            nb_samples, hidden_layers, number_of_epochs, diff)
