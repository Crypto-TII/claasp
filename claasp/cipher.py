...
class Cipher:
    ...
    def train_neural_distinguisher(self, data_generator, starting_round, neural_network, training_samples=10**7, testing_samples=10**6, pipeline = True):
        ...
        if pipeline:
            ...
            acc = neural_staged_training(self, data_generator, starting_round, neural_network)
        else:
            from claasp.cipher_modules.neural_network_tests import train_neural_distinguisher
            acc = train_neural_distinguisher(self, data_generator, starting_round, neural_network)
        return acc
