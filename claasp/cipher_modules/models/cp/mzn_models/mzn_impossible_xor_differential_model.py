...
from claasp.cipher_modules.models.utils import convert_solver_solution_to_dictionary, _convert_impossible_xor_differential_solution_to_dictionnary, \
    set_components_variables_to_one
