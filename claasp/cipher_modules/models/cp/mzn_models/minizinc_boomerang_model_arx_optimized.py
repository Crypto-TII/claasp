...
from claasp.cipher_modules.models.cp.utils.mzn_bct_predicates import get_bct_operations
from claasp.cipher_modules.models.cp.mzn_models.cp_xor_differential_model_ARX_optimized import \
    MinizincXorDifferentialModelARXOptimized
from claasp.cipher_modules.models.cp.utils.utils import group_strings_by_pattern


class MinizincBoomerangModel(MinizincXorDifferentialModelARXOptimized):
