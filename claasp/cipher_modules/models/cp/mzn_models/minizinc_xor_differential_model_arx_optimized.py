...
from claasp.cipher_modules.models.cp.minizinc_model import MinizincModel
...
class MinizincXorDifferentialModelARXOptimized(MinizincModel):
    ...
    def build_xor_differential_trail_model(self, weight=-1, fixed_variables=[]):
        ...
        EXAMPLES::
            ...
            sage: from claasp.cipher_modules.models.cp.mzn_models.cp_xor_differential_model import MinizincXorDifferentialModel
