        ...
        if number_of_unknowns_per_component:
            ...
            for component_id in list(number_of_unknowns_per_component.keys()):
                if component_id in self._cipher.get_all_components_ids():
                    ...
                    self._variables_list.extend(unknown_variables)
                    self._model_constraints.extend(unknown_constraints)
                else:
                    raise ValueError(f'Component {component.id} not found in number_of_unknowns_per_component')
