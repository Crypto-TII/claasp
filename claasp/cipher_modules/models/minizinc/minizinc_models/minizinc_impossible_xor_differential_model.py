...
class MinizincImpossibleXorDifferentialModel(MinizincDeterministicTruncatedXorDifferentialModel):
    ...
    def build_impossible_xor_differential_trail_model(self, fixed_variables=[], number_of_rounds=None, middle_round=1):
        ...
        EXAMPLES::
            ...
            sage: minizinc.build_impossible_xor_differential_trail_model(fixed_variables)
        """
    ...
    def find_all_impossible_xor_differential_trails(self, number_of_rounds,
                                                                fixed_values=[], solver_name=SOLVER_DEFAULT, middle_round=1, solve_with_API=False):
        """
