...
class MinizincDeterministicTruncatedXorDifferentialModelARXOptimized(MinizincModel):
    ...
    def build_deterministic_truncated_xor_differential_trail_model(self, fixed_variables=[]):
        ...
        EXAMPLES::
            ...
            sage: from claasp.cipher_modules.models.cp.mzn_models.cp_deterministic_truncated_xor_differential_model_arx_optimized import MinizincDeterministicTruncatedXorDifferentialModelARXOptimized
            sage: speck = SpeckBlockCipher(number_of_rounds=22)
            sage: minizinc = MinizincDeterministicTruncatedXorDifferentialModelARXOptimized(speck)
