...
class MinizincXorDifferentialModelARXOptimized(MinizincModel):
    ...
    def _parse_solution(
        ...
        if result_status in [Status.SATISFIED, Status.ALL_SOLUTIONS, Status.OPTIMAL_SOLUTION]:
            ...
            probability_vars_weights = MinizincXorDifferentialModelARXOptimized.parse_probability_vars(
    ...
    def _parse_result(
        ...
        if total_weight == "list_of_solutions":
            ...
            for solution in result.solution:
                ...
                if result.status in [Status.SATISFIED, Status.ALL_SOLUTIONS, Status.OPTIMAL_SOLUTION]:
                    parsed_solution_temp = MinizincXorDifferentialModelARXOptimized._parse_solution(
    ...
    def build_xor_differential_trail_model(self, weight=-1, fixed_variables=[]):
        ...
        EXAMPLES::
            ...
            sage: from claasp.cipher_modules.models.minizinc.minizinc_models.minizinc_xor_differential_model_arx_optimized import MinizincXorDifferentialModelARXOptimized
            sage: speck = SpeckBlockCipher(number_of_rounds=22)
            sage: minizinc = MinizincXorDifferentialModelARXOptimized(speck)
    ...
    def find_all_xor_differential_trails_with_fixed_weight(self, fixed_weight, fixed_values=[], solver_name=None):
        ...
        self._model_constraints.extend(self.weight_constraints(fixed_weight, "="))
        result = self.solve_with_API(solver_name=solver_name, all_solutions_=True)
        total_weight = MinizincXorDifferentialModelARXOptimized._get_total_weight(result)
        parsed_result = MinizincXorDifferentialModelARXOptimized._parse_result(
    ...
    def find_min_of_max_xor_differential_between_permutation_and_key_schedule(
        ...
        result = self.solve_with_API(solver_name=solver_name)
    ...
    def find_lowest_weight_xor_differential_trail(self, fixed_values=[], solver_name=None):
        ...
        EXAMPLES::
            ...
            sage: minizinc = MinizincXorDifferentialModelARXOptimized(speck, [0, 0, 0, 0, 0])
    ...
    def init_constraints(self):
        ...
        for i in range(len(self._cipher.inputs)):
            ...
            output_string_for_cipher_input = \
                ...
                MinizincXorDifferentialModelARXOptimized._create_minizinc_1d_array_from_list(var_names_inputs) + ")++\"\\n\"];\n"
