...
from claasp.cipher_modules.models.minizinc.solvers import MODEL_DEFAULT_PATH, SOLVER_DEFAULT


class MinizincDeterministicTruncatedXorDifferentialModel(MinizincModel):
    ...
    def build_deterministic_truncated_xor_differential_trail_model(self, fixed_variables=[], number_of_rounds=None):
        ...
        EXAMPLES::
            ...
            sage: from claasp.cipher_modules.models.minizinc.minizinc_models.minizinc_deterministic_truncated_xor_differential_model import MinizincDeterministicTruncatedXorDifferentialModel
            sage: from claasp.ciphers.block_ciphers.speck_block_cipher import SpeckBlockCipher
            sage: from claasp.cipher_modules.models.utils import set_fixed_variables, integer_to_bit_list
            sage: speck = SpeckBlockCipher(block_bit_size=32, key_bit_size=64, number_of_rounds=2)
            sage: minizinc = MinizincDeterministicTruncatedXorDifferentialModel(speck)
            sage: fixed_variables = [set_fixed_variables('key', 'equal', range(64), integer_to_bit_list(0, 64, 'little'))]
            sage: minizinc.build_deterministic_truncated_xor_differential_trail_model(fixed_variables)
        """
    ...
    def build_inverse_deterministic_truncated_xor_differential_trail_model(self, number_of_rounds=None, fixed_variables=[]):
        ...
        EXAMPLES::
            ...
            sage: minizinc.build_inverse_deterministic_truncated_xor_differential_trail_model(2, fixed_variables)
        """
        self._model_prefix = []
        self._variables_list = []
        constraints = self.fix_variables_value_constraints(fixed_variables)
    ...
    def final_deterministic_truncated_xor_differential_constraints(self):
        ...
        EXAMPLES::
            ...
            sage: minizinc = MinizincDeterministicTruncatedXorDifferentialModel(speck)
            sage: minizinc.final_deterministic_truncated_xor_differential_constraints()[:-1]
            ['solve satisfy;']
        """
    ...
    def final_impossible_constraints(self, number_of_rounds=None):
        ...
        EXAMPLES::
            ...
            sage: speck = SpeckBlockCipher(number_of_rounds=2)
            sage: minizinc = MinizincDeterministicTruncatedXorDifferentialModel(speck)
            sage: minizinc.final_impossible_constraints(2)[:-2]
            ['solve satisfy;']
        """
        cipher_inputs = self._cipher.inputs
        cipher = self._cipher
    ...
    def find_all_deterministic_truncated_xor_differential_trail(self, number_of_rounds=None,
        ...
        EXAMPLES::
            ...
            ....:         bit_values=[0]*64)
            sage: minizinc.find_all_deterministic_truncated_xor_differential_trail(3, [plaintext,key], 'Chuffed') # random
        ...
        if solve_with_API:
            return self.solve_with_API(solver_name = solver_name)
        else:
    ...
    def find_one_deterministic_truncated_xor_differential_trail(self, number_of_rounds=None,
        ...
        EXAMPLES::
            ...
            ....:         bit_positions=range(64),
            ....:         bit_values=[0]*64)
            sage: minizinc.find_one_deterministic_truncated_xor_differential_trail(1, [plaintext,key], 'Chuffed') # random
    ...
    def input_deterministic_truncated_xor_differential_constraints(self):
        ...
        EXAMPLES::
            ...
            sage: minizinc = MinizincDeterministicTruncatedXorDifferentialModel(aes)
            sage: minizinc.input_deterministic_truncated_xor_differential_constraints(10)
    ...
    def input_wordwise_deterministic_truncated_xor_differential_constraints(self):
        ...
        EXAMPLES::
            ...
            sage: minizinc = MinizincDeterministicTruncatedXorDifferentialModel(aes)
            sage: minizinc.input_wordwise_deterministic_truncated_xor_differential_constraints()
    ...
    def output_constraints(self, component):
        ...
        EXAMPLES::
            ...
            sage: minizinc.output_constraints(output_component)
            ([],
    ...
    def output_inverse_constraints(self, component):
        ...
        EXAMPLES::
            ...
            sage: minizinc = MinizincDeterministicTruncatedXorDifferentialModel(speck)
            sage: output_component = speck.component_from(0, 5)
            sage: minizinc.output_inverse_constraints(output_component)
            ([],
    ...
    def _parse_solver_output(self, output_to_parse, model_type):
        ...
        EXAMPLES::
            ...
            sage: from claasp.cipher_modules.models.minizinc.minizinc_models.minizinc_xor_differential_trail_search_model import MinizincXorDifferentialTrailSearchModel
            sage: from claasp.ciphers.block_ciphers.speck_block_cipher import SpeckBlockCipher
            ...
            sage: minizinc = MinizincXorDifferentialTrailSearchModel(speck)
            sage: fixed_variables = [set_fixed_variables('key', 'equal', range(64), integer_to_bit_list(0, 64, 'little'))]
            ...
            sage: write_model_to_file(minizinc._model_constraints,'doctesting_file.mzn')
            ...
            sage: minizinc._parse_solver_output(solver_output) # random
            (0.018,
             ...
    ...
    def solve(self, model_type, solver_name=SOLVER_DEFAULT, num_of_processors=None, timelimit=None):
        ...
        EXAMPLES::
            ...
            sage: minizinc.build_xor_differential_trail_model(-1, fixed_variables)
            sage: minizinc.solve('xor_differential', 'Chuffed') # random
        ...
        input_file_path = f'{MODEL_DEFAULT_PATH}/{cipher_name}_Minizinc_{model_type}_{solver_name}.mzn'
