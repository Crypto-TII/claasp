...
class MinizincCipherModelARXOptimized(MinizincModel):
    ...
    def build_cipher_model(self, fixed_variables=[]):
        ...
        EXAMPLES::
            ...
            sage: from claasp.cipher_modules.models.minizinc.minizinc_models.minizinc_cipher_model_arx_optimized import MinizincCipherModelARXOptimized
            sage: speck = SpeckBlockCipher(number_of_rounds=22)
            sage: minizinc = MinizincCipherModelARXOptimized(speck)
