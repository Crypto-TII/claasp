...
def build_xor_truncated_table(numadd):
    ...
    EXAMPLES::
        ...
        sage: from claasp.cipher_modules.models.minizinc.minizinc_models.minizinc_xor_differential_number_of_active_sboxes_model import (
...
class MinizincXorDifferentialNumberOfActiveSboxesModel(MinizincModel):
    ...
    def add_additional_xor_constraints(self, nmax, repetition):
        ...
        EXAMPLES::
            ...
            sage: minizinc = MinizincXorDifferentialNumberOfActiveSboxesModel(aes)
            ...
            sage: minizinc.add_additional_xor_constraints(5,1)
    ...
    def create_xor_component(self, component1, component2, nmax):
        ...
        EXAMPLES::
            ...
            sage: minizinc.create_xor_component(xor_component1, xor_component2, 25)
    ...
    def final_xor_differential_first_step_constraints(self, weight=-1):
        ...
        EXAMPLES::
            ...
            sage: aes = AESBlockCipher()
            sage: minizinc = MinizincXorDifferentialNumberOfActiveSboxesModel(aes)
            sage: minizinc.final_xor_differential_first_step_constraints()
    ...
    def input_xor_differential_first_step_constraints(self, possible_sboxes):
        ...
        EXAMPLES::
            ...
            sage: aes = AESBlockCipher()
            sage: minizinc = MinizincXorDifferentialNumberOfActiveSboxesModel(aes)
            sage: minizinc.input_xor_differential_first_step_constraints()
    ...
    def xor_xor_differential_first_step_constraints(self, component):
        ...
        EXAMPLES::
            ...
            sage: minizinc.xor_xor_differential_first_step_constraints(xor_component)
