...
from claasp.cipher_modules.models.minizinc.minizinc_model import solve_satisfy
...
from claasp.cipher_modules.models.minizinc.minizinc_models.minizinc_xor_differential_model import (
    MinizincXorDifferentialModel, update_and_or_ddt_valid_probabilities)
from claasp.cipher_modules.models.minizinc.minizinc_models.minizinc_xor_differential_number_of_active_sboxes_model import (
    MinizincXorDifferentialNumberOfActiveSboxesModel)
from claasp.cipher_modules.models.minizinc.solvers import CP_SOLVERS_EXTERNAL, CP_SOLVERS_INTERNAL, MODEL_DEFAULT_PATH, SOLVER_DEFAULT


class MinizincXorDifferentialFixingNumberOfActiveSboxesModel(MinizincXorDifferentialModel,
                                                       MinizincXorDifferentialNumberOfActiveSboxesModel):
    ...
    def build_xor_differential_trail_second_step_model(self, weight=-1, fixed_variables=[]):
        ...
        EXAMPLES::
            ...
            sage: from claasp.cipher_modules.models.minizinc.minizinc_models.minizinc_xor_differential_trail_search_fixing_number_of_active_sboxes_model import (
            ....: MinizincXorDifferentialTrailSearchFixingNumberOfActiveSboxesModel)
            sage: from claasp.ciphers.block_ciphers.aes_block_cipher import AESBlockCipher
            sage: from claasp.cipher_modules.models.utils import set_fixed_variables, integer_to_bit_list
            sage: aes = AESBlockCipher(number_of_rounds=2)
            sage: minizinc = MinizincXorDifferentialTrailSearchFixingNumberOfActiveSboxesModel(aes)
            sage: fixed_variables = [set_fixed_variables('key', 'not_equal', range(128),
            ....: integer_to_bit_list(0, 128, 'little'))]
            sage: minizinc.build_xor_differential_trail_second_step_model(-1, fixed_variables)
        """
        self.c = 0
        self.sbox_mant = []
    ...
    def find_all_xor_differential_trails_with_fixed_weight(self, fixed_weight, fixed_values=[], first_step_solver_name=SOLVER_DEFAULT, second_step_solver_name=SOLVER_DEFAULT):
        ...
        EXAMPLES::
            ...
            ....: integer_to_bit_list(0, 128, 'little')))
            sage: trails = minizinc.find_all_xor_differential_trails_with_fixed_weight(224, fixed_variables, 'Chuffed', 'Chuffed') # long
            ...
    ...
    def find_lowest_weight_xor_differential_trail(self, fixed_values=[], first_step_solver_name=SOLVER_DEFAULT, second_step_solver_name=SOLVER_DEFAULT):
        ...
        EXAMPLES::
            ...
            sage: fixed_variables.append(set_fixed_variables('plaintext', 'not_equal', range(128),
            ....: integer_to_bit_list(0, 128, 'little')))
            sage: minizinc.find_lowest_weight_xor_differential_trail(fixed_variables, 'Chuffed', 'Chuffed') # random
    ...
    def find_one_xor_differential_trail(self, fixed_values=[], first_step_solver_name=SOLVER_DEFAULT, second_step_solver_name=SOLVER_DEFAULT):
        ...
        EXAMPLES::
            ...
            sage: fixed_variables.append(set_fixed_variables('plaintext', 'not_equal', range(128),
            ....: integer_to_bit_list(0, 128, 'little')))
            sage: minizinc.find_one_xor_differential_trail(fixed_variables, 'Chuffed', 'Chuffed') # random
            {'cipher_id': 'aes_block_cipher_k128_p128_o128_r2',
             'model_type': 'xor_differential',
              ...
    ...
    def find_one_xor_differential_trail_with_fixed_weight(self, fixed_weight=-1, fixed_values=[], first_step_solver_name=SOLVER_DEFAULT, second_step_solver_name=SOLVER_DEFAULT):
        ...
        EXAMPLES::
            ...
            sage: fixed_variables.append(set_fixed_variables('plaintext', 'not_equal', range(128),
            ....: integer_to_bit_list(0, 128, 'little')))
            sage: minizinc.find_one_xor_differential_trail_with_fixed_weight(224, fixed_variables, 'Chuffed', 'Chuffed') # random
            {'cipher_id': 'aes_block_cipher_k128_p128_o128_r2',
             'model_type': 'xor_differential',
             'solver_name': 'Chuffed',
             ...
    ...
    def generate_table_of_solutions(self, solution, solver_name):
        ...
        EXAMPLES::
            ...
            ....: integer_to_bit_list(0, 128, 'little'))]
            sage: minizinc.build_xor_differential_trail_first_step_model(-1,fixed_variables)
    ...
    def solve_full_two_steps_xor_differential_model(self, model_type='xor_differential_one_solution', weight=-1, fixed_variables=[],
        ...
        EXAMPLES::
            ...
            sage: fixed_variables = [set_fixed_variables('key', 'not_equal', list(range(128)),
            ....: integer_to_bit_list(0, 128, 'little'))]
            sage: minizinc.solve_full_two_steps_xor_differential_model('xor_differential_one_solution', -1, fixed_variables, 'Chuffed', 'Chuffed') # random
        ...
        build_time += end - start
        input_file_name = f'{MODEL_DEFAULT_PATH}/{cipher_name}_Minizinc_xor_differential_{first_step_solver_name}.mzn'
    ...
    def solve_model(self, model_type, solver_name=None):
        ...
        EXAMPLES::
            ...
            ....: integer_to_bit_list(0, 128, 'little'))]
            sage: minizinc.build_xor_differential_trail_first_step_model(-1, fixed_variables)
            sage: minizinc.solve_model('xor_differential_first_step', 'Chuffed') # random
            ['1',
        ...
        start = tm.time()
        cipher_name = self.cipher_id
        input_file_name = f'{MODEL_DEFAULT_PATH}/{cipher_name}_Minizinc_{model_type}_{solver_name}.mzn'
        for i in range(len(CP_SOLVERS_EXTERNAL)):
    ...
    def transform_first_step_model(self, attempt, active_sboxes, weight=-1):
        ...
        EXAMPLES::
            ...
            ....: integer_to_bit_list(0, 128, 'little'))]
            sage: minizinc.build_xor_differential_trail_first_step_model(-1, fixed_variables)
            sage: first_step_solution, solve_time = minizinc.solve_model('xor_differential_first_step','Chuffed')
            sage: minizinc.transform_first_step_model(0, first_step_solution[0])
        """
        print(active_sboxes)
