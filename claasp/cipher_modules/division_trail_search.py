...
class MilpDivisionTrailModel():
    ...
    EXAMPLES::
        ...
        sage: milp.find_anf_of_specific_output_bit(0) #SKIP
        ...
        sage: from claasp.cipher_modules.division_trail_search import *
        sage: milp = MilpDivisionTrailModel(cipher)
        sage: milp.find_anf_of_specific_output_bit(1) #SKIP
        ...
        sage: from claasp.cipher_modules.division_trail_search import *
        sage: milp = MilpDivisionTrailModel(cipher)
        sage: milp.check_presence_of_particular_monomial_in_specific_anf([("plaintext", 0)], 0) #SKIP

        sage: from claasp.ciphers.block_ciphers.speck_block_cipher import SpeckBlockCipher
        sage: cipher = SpeckBlockCipher(number_of_rounds=1)
        sage: from claasp.cipher_modules.division_trail_search import *
        sage: milp = MilpDivisionTrailModel(cipher)
        sage: milp.find_anf_of_specific_output_bit(15) #SKIP
        ...
        sage: from claasp.cipher_modules.division_trail_search import *
        sage: milp = MilpDivisionTrailModel(cipher)
        sage: milp.find_anf_of_specific_output_bit(0, fixed_degree=1) #SKIP

        sage: from claasp.ciphers.block_ciphers.aradi_block_cipher import AradiBlockCipher
        sage: cipher = AradiBlockCipher(number_of_rounds=2)
        sage: from claasp.cipher_modules.division_trail_search import *
        sage: milp = MilpDivisionTrailModel(cipher)
        sage: milp.check_presence_of_particular_monomial_in_specific_anf([("plaintext", 0), ("plaintext", 32), ("plaintext", 64), ("plaintext", 96)], 0) #SKIP
