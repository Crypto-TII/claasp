...
PARAMETERS_CONFIGURATION_LIST = [{"bit_size": 8, "shift_amount": 1}]
...
class ShiftCipher(SingleComponentCipher):
    ...
    - ``shift_amount`` -- **integer** (default: `1`); shift amount (positive = left, negative = right)
    ...
    EXAMPLES::
        ...
        1
    """
    def __init__(self, bit_size=8, shift_amount=1):
        super().__init__(
        ...
        shift_component = self.add_shift_component([INPUT_PLAINTEXT], [list(range(bit_size))], bit_size, shift_amount)
