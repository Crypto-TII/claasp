...
class ModsubBlockCipher(SingleComponentCipher):
    """
    Return a single-round cipher made of a single modular-subtraction component.
    ...
    EXAMPLES::
        ...
        sage: from claasp.ciphers.single_component_ciphers.modsub_block_cipher import ModsubBlockCipher
        sage: modsub = ModsubBlockCipher(word_bit_size=4, number_of_inputs=2, modulus=16)
        sage: modsub.type
        'block_cipher'

        sage: modsub.component_from(0, 0).id
        'modsub_0_0'

        sage: modsub.evaluate([3, 5])
        14
    """
    ...
    def __init__(self, word_bit_size=4, number_of_inputs=2, modulus=None):
        ...
        super().__init__(
            family_name="modsub_block_cipher",
