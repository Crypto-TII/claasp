...
class ZucStreamCipher(Cipher):
    ...
    def linear_transform_L1(self, W1, W2):
        self.add_rotate_component([W1.id[0], W2.id[0]], [list(range(16, WORD_SIZE)), list(range(0, 16))], WORD_SIZE, -2)
        rot1 = ComponentState([self.get_current_component_id()], [list(range(WORD_SIZE))])

        self.add_rotate_component([W1.id[0], W2.id[0]], [list(range(16, WORD_SIZE)), list(range(0, 16))], WORD_SIZE, -10)
        rot2 = ComponentState([self.get_current_component_id()], [list(range(WORD_SIZE))])

        self.add_rotate_component([W1.id[0], W2.id[0]], [list(range(16, WORD_SIZE)), list(range(0, 16))], WORD_SIZE, -18)
        rot3 = ComponentState([self.get_current_component_id()], [list(range(WORD_SIZE))])

        self.add_rotate_component([W1.id[0], W2.id[0]], [list(range(16, WORD_SIZE)), list(range(0, 16))], WORD_SIZE, -24)
        rot4 = ComponentState([self.get_current_component_id()], [list(range(WORD_SIZE))])
    ...
    def linear_transform_L2(self, W1, W2):
        ...
        self.add_rotate_component([W1.id[0], W2.id[0]], [list(range(16, WORD_SIZE)), list(range(0, 16))], WORD_SIZE, -8)
        rot1 = ComponentState([self.get_current_component_id()], [list(range(WORD_SIZE))])

        self.add_rotate_component([W1.id[0], W2.id[0]], [list(range(16, WORD_SIZE)), list(range(0, 16))], WORD_SIZE, -14)
        rot2 = ComponentState([self.get_current_component_id()], [list(range(WORD_SIZE))])

        self.add_rotate_component([W1.id[0], W2.id[0]], [list(range(16, WORD_SIZE)), list(range(0, 16))], WORD_SIZE, -22)
        rot3 = ComponentState([self.get_current_component_id()], [list(range(WORD_SIZE))])

        self.add_rotate_component([W1.id[0], W2.id[0]], [list(range(16, WORD_SIZE)), list(range(0, 16))], WORD_SIZE, -30)
        rot4 = ComponentState([self.get_current_component_id()], [list(range(WORD_SIZE))])
