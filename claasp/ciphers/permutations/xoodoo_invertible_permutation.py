...
class XoodooInvertiblePermutation(Cipher):
    """
    ...
    EXAMPLES::
        ...
        sage: xoodoo_invertible_permutation.number_of_rounds
        3

        sage: xoodoo_invertible_permutation.component_from(0, 0).id
        'theta_xoodoo_0_0'
    """
    ...
    def __init__(self, number_of_rounds=12):
        ...
        for round_number in range(0, number_of_rounds):
            ...
            # round parameter
            round_i = round_number - number_of_rounds + 1
            ci = get_ci(round_i, QI, SI, t)
            planes = self.round_function(planes, ci)

            self.add_output_component(number_of_rounds, planes, round_number)

    def add_output_component(self, number_of_rounds, planes, round_number):
    ...
    def round_function(self, planes, ci):
        planes = self.theta_definition(planes)
