...
from claasp.utils.utils import get_ci, layer_and_lane_initialization, simplify_inputs
...
class XoodooPermutation(Cipher):
    ...
    The standard 6- and 12-round instances are implemented by the designers' XKCP reference package [XKCPREF]_.
