...
ICOUNTER_IV_160 = [
    0x75, 0x6A, 0x54, 0x29, 0x53, 0x27, 0x4F, 0x1F, 0x3E, 0x7D, 0x7A, 0x74, 0x68, 0x50, 0x21, 0x43,
...
ICOUNTER_IV_160_REV = [
    0xAE, 0x56, 0x2A, 0x94, 0xCA, 0xE4, 0xF2, 0xF8, 0x7C, 0xBE, 0x5E, 0x2E, 0x16, 0x0A, 0x84, 0xC2,
...
ICOUNTER_IV_176 = [
    0x45, 0x0B, 0x16, 0x2C, 0x59, 0x33, 0x67, 0x4E, 0x1D, 0x3A, 0x75, 0x6A, 0x54, 0x29, 0x53, 0x27,
...
ICOUNTER_IV_176_REV = [
    0xA2, 0xD0, 0x68, 0x34, 0x9A, 0xCC, 0xE6, 0x72, 0xB8, 0x5C, 0xAE, 0x56, 0x2A, 0x94, 0xCA, 0xE4,
...
class SpongentPiPrecomputationPermutation(Cipher):
    ...
    def __init__(self, state_bit_size=160, number_of_rounds=80):
        ...
        super().__init__(
            family_name="spongent_pi_precomputation",
