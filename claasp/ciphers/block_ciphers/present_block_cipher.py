...
def present_encrypt(plaintext, key):
    from claasp.utils.integer_functions import (wordlist_to_int, int_to_wordlist, wordlist_to_int,
                                             bytearray_to_int, bytearray_to_wordlist, int_to_bytearray)
...
class PresentBlockCipher(Cipher):
    ...
    def __init__(self, key_bit_size=80, number_of_rounds=None):
        ...
        super().__init__(family_name="present", cipher_type="block_cipher",
    ...
    def update_key_register(self, key, r):
        ...
        if self.key_bit_size == 80:
            ...
            return [sbox_1, sbox_2, rot, xor, rot], [list(range(4)), list(range(4)), list(range(8, 61)),
                                                     list(range(5)), list(range(66, 128))]
