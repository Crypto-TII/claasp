...
class DESBlockCipher_1round(Cipher):
    """
    ...
    EXAMPLES::
        ...
        sage: from claasp.ciphers.block_ciphers.des_1round import DESBlockCipher_1round
        sage: des = DESBlockCipher_1round()
        sage: key = 0
        sage: plaintext = 1
        sage: hex(des.evaluate([key, plaintext]))
    """

    def __init__(self, number_of_rounds=1, number_of_sboxes=8):
