...
class ThreefishBlockCipher(Cipher):
    ...
    def __init__(self, block_bit_size=256, key_bit_size=256, tweak_bit_size=128, number_of_rounds=0):
        ...
        if number_of_rounds == 0:
            ...
            for parameters in PARAMETERS_CONFIGURATION_LIST:
                if (
                    ...
                    and parameters["tweak_bit_size"] == tweak_bit_size
                ):
        ...
        super().__init__(
            ...
            cipher_reference_code=reference_code.format(self.block_bit_size, key_bit_size, tweak_bit_size, n),
        )
    ...
    def word_permutation(self, data):
        wperm_id = self.add_word_permutation_component(
            *data, self.block_bit_size, PERMUTATIONS[self.n], self.word_size
        ).id
