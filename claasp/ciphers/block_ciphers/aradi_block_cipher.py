...
class AradiBlockCipher(Cipher):
    ...
    def round_function(self, state, round_key, round_i):
        ...
        wl, wr = self.l_function(w, x_bits, y_bits, round_i)
        xl, xr = self.l_function(x, x_bits, y_bits, round_i)
        yl, yr = self.l_function(y, x_bits, y_bits, round_i)
        zl, zr = self.l_function(z, x_bits, y_bits, round_i)
