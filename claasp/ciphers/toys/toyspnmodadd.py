    ...
    def __init__(self,
        ...
        for _ in range(number_of_rounds):
            ...
            for ns in range(self.number_of_sboxes):
                sbox_component = self.add_SBOX_component([modadd.id],
            ...
            modadd_input1 = rotate_component.id
