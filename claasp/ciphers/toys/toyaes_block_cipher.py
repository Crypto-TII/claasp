...
class ToyAESBlockCipher(Cipher):
    """
    Return a cipher object of Toy AES Block Cipher.
    
    This is a parameterized toy version of AES with configurable word_size and state_size.
    For the standard AES-128/192/256 implementation, see aes_block_cipher.py.
    ...
    def __init__(self, number_of_rounds: int = 10, word_size: int = 8, state_size: int = 4):
        ...
        super().__init__(
            family_name="toyaes_block_cipher",
        ...
        # Rounds definition:
        # Round 0 different from others sinceit starts with first_add_round_key
        self.add_round()
